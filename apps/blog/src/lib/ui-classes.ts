export const ui = {
  ...
  brand:
    "inline-flex items-center gap-2.5 text-ink font-[780] tracking-[0] transition-opacity duration-[160ms] hover:opacity-80",
  brandMark:
    "inline-block h-[18px] w-[18px] rounded-md bg-[linear-gradient(135deg,var(--color-accent),var(--color-teal)_58%,var(--color-rust))] bg-[length:250%_250%] animate-[brand-gradient_6s_ease-in-out_infinite]",
  navLinks:
    "flex items-center gap-1.5 text-[0.92rem] max-[640px]:w-full",
  navLink:
    "relative rounded-lg px-2.5 py-2 text-muted-strong transition-[background,color] duration-[160ms] after:absolute after:inset-x-2.5 after:bottom-1 after:h-0.5 after:origin-left after:scale-x-0 after:rounded-[1px] after:bg-[linear-gradient(90deg,var(--color-accent),var(--color-teal))] after:transition-transform after:duration-[220ms] after:ease-out-expo after:content-[''] hover:bg-soft hover:text-ink hover:no-underline hover:after:scale-x-100 max-[640px]:px-2",
  shell:
  ...
  summaryPill:
    "rounded-full border border-line bg-paper px-2.5 py-[7px] text-[0.82rem] font-[680] leading-none text-muted",
  ...
  tagPill:
    "tag rounded-full border border-line bg-paper px-2.5 py-[7px] text-[0.82rem] font-[680] leading-none text-ink-soft transition-[background,border-color,color,transform,box-shadow] duration-[200ms] ease-spring hover:-translate-y-0.5 hover:scale-[1.02] hover:border-accent-blend hover:bg-accent-soft hover:text-accent-ink hover:shadow-[0_2px_10px_rgb(29_31_27_/_6%)] hover:no-underline",
  archiveSection: "mt-12",
  sectionHeading: "mb-[18px] flex items-end justify-between",

  postList: "post-list grid gap-3.5",
  postCard:
    "post-item rounded-lg border border-line bg-paper transition-[border-color,box-shadow,transform] duration-[240ms] ease-spring hover:-translate-y-px hover:border-accent-blend hover:shadow-glow-sm",
  postCardLink:
    "block px-[22px] py-5 text-inherit hover:no-underline max-[640px]:p-[18px]",
  postTopline:
    "mb-[9px] flex flex-wrap items-center justify-between gap-2.5 text-[0.8rem] font-[720] uppercase text-muted max-[640px]:flex-col max-[640px]:items-start max-[640px]:gap-[3px]",
  postSeries: "tracking-[0.08em] text-teal",
  ...
  relatedCard:
    "related-card rounded-lg border border-line bg-paper p-4 text-inherit transition-[border-color,box-shadow,transform] duration-[200ms] ease-spring hover:-translate-y-0.5 hover:border-accent-blend hover:shadow-glow-sm hover:no-underline",
  relatedKicker:
    "mb-1.5 block text-[0.76rem] font-[760] uppercase tracking-[0.08em] text-teal",
  relatedMeta: "text-muted",
  relatedDescription: "m-0 mt-2 text-muted",

  searchBox:
    "search-box mb-6 w-full max-w-[620px] rounded-lg border border-line-strong bg-paper px-3.5 py-[13px] text-ink shadow-[0_10px_28px_rgb(29_31_27_/_5%)] transition-[border-color,box-shadow] duration-[200ms] focus:border-[color-mix(in_srgb,var(--color-accent)_42%,var(--color-line))] focus:shadow-glow-sm focus:outline-none",

  themeToggle:
    "theme-toggle group flex cursor-pointer items-center rounded-lg border-0 bg-transparent px-2.5 py-2 leading-none text-muted-strong transition-[background,color,transform] duration-[200ms] ease-spring hover:scale-110 hover:rotate-12 hover:bg-soft hover:text-ink",
